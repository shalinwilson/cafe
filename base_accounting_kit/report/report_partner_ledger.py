...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        print(data['computed']['ACCOUNT_TYPE'])
        self.env.cr.execute("""
            SELECT a.id
        ...
        print(data['computed']['account_ids'],"AsddddddddddddddddddddddddddddddDDDDDDDDDd")
        print(data['computed']['account_ids'])
...
#                 AND "account_move_line".account_id IN %s
#                 AND NOT account.deprecated
#                 AND ((((("account_move_line"."journal_id" in %s) AND ("account_move_line"."parent_state" = %s)) AND
#                 ("account_move_line"."company_id" in %s)) AND (("account_move_line"."display_type" not in %s) OR
#                 "account_move_line"."display_type" IS NULL)) AND (("account_move_line"."parent_state" != %s) OR "account_move_line"."parent_state" IS NULL)) AND
#                 ("account_move_line"."company_id" IS NULL  OR ("account_move_line"."company_id" in %s)) AND "account_move_line".full_reconcile_id IS NULL
#                 (('posted',), (11, 12), (6, 1, 2, 3, 4, 9, 8, 5, 7, 10), 'posted', (1,), ('line_section', 'line_note'), 'cancel', (1,))
